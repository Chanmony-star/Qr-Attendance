      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        <AnimatedSection>
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-[1.1]">
            ...
            <br />
            <span className="text-brand-400">for Attendance Management</span>
          </h2>

          <p className="mt-6 text-lg sm:text-xl text-blue-100/60 max-w-xl mx-auto leading-relaxed">
            Sign in with your institutional Google account to create sessions,
            generate QR codes, and track attendance in real time.
          </p>
          ...
          <div className="mt-10">
            <Button
              variant="primary"
              size="xl"
              className="gap-3 bg-white text-navy-950 hover:bg-blue-50 shadow-xl shadow-brand-600/20 text-base"
            >
